...
CKUSDT_LEDGER_ID_MAINNET="cngnf-vqaaa-aaaar-qag4q-cai"
...
CKUSDT_LEDGER_ID_TESTNET="yfumr-cyaaa-aaaar-qaela-cai"
...
OPTIONS_CANISTER_ID_MAINNET="5zttn-xyaaa-aaaam-adqba-cai"
#
#local Ids
#
...
CKUSDT_LEDGER_ID_LOCAL="yfumr-cyaaa-aaaar-qaela-cai"
...
OPTIONS_CANISTER_ID_LOCAL="222iv-iiaaa-aaaak-qdyla-cai"
...
function setUpLocalEnvs() {
    
    {
        ...
        echo "NEXT_PUBLIC_CKUSDT_LEDGER_ID=$CKUSDT_LEDGER_ID_LOCAL"
        ...
        echo "NEXT_PUBLIC_OPTIONS_CANISTER_ID=$OPTIONS_CANISTER_ID_LOCAL"
        #
        #
        #
...
function setUpICEnvs() {
    
    {
        ...
        echo "NEXT_PUBLIC_CKUSDT_LEDGER_ID=$CKUSDT_LEDGER_ID_TESTNET"
        ...
        echo "NEXT_PUBLIC_OPTIONS_CANISTER_ID=$OPTIONS_CANISTER_ID_MAINNET"
...
function main() {
    ...
    if [[ $NETWORK == "local" ]]; then
        ...
        dfx deploy  --network="$NETWORK"  aegis_dapp --specified-id 222b6-2iaaa-aaaaj-qi4uq-cai
