...
import { idlFactory } from './aegis_dapp.did.js';
export { idlFactory } from './aegis_dapp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AEGIS_DAPP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./aegis_dapp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the aegis_dapp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./aegis_dapp.did.js")._SERVICE>}
 */
export const aegis_dapp = createActor(canisterId);
